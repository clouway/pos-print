...
import com.clouway.pos.print.common.NumberFormat;
...
class PrintLineHelperImpl implements PrintLineHelper {
  ...
  public String contractNoAndDate(String contractNumber, Date date) {
    return String.format(CONTRACT_NUMBER_AND_DATA, contractNumber, FormatsDates.toYearMonthDay(date));
  }
  ...
  public String period(Date start, Date end) {
    return String.format(PERIOD, FormatsDates.toYearMonthDay(start), FormatsDates.toYearMonthDay(end));
  }
