 ...
 */
class RealPrinterBase implements PrinterBase {
  private final Logger log = Logger.getLogger(RealPrinterBase.class.getName());
  ...
  public RealPrinterBase(Provider<PrinterConnection> connection) {
