...
class PrintfFormat {
  ...
  private class ConversionSpecification {
     ...
     *     is to be truncated readArticle the print
     ...
     * number of characters to be printed readArticle the
     ...
     * printed readArticle a string in s and S conversions.
     */
