...
class InMemoryPrinterConfigurationBase implements PrinterConfigurationBase{
  ...
  final ImmutableMap<String, NetworkPrinterConfiguration> CONFIGURATIONS =
          new ImmutableMap.Builder<String, NetworkPrinterConfiguration>()
                  ...
                  .put("85.217.129.114", new NetworkPrinterConfiguration("85.217.129.119", 1024))
                  ...
                  // gorna
                  .put("85.217.131.21",new NetworkPrinterConfiguration("10.10.24.32", 1024))
                  ...
                  // tyrnovo/pishmana
                  .put("85.217.131.17", new NetworkPrinterConfiguration("10.10.24.35", 1024))
